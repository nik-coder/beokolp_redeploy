...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Beokolp</a>		</p>
			</div>
...
<script type="text/javascript" src="./wp-admin/js/password-strength-meter.min.js?ver=5.7" id="password-strength-meter-js"></script>
<script type="text/javascript" src="./wp-includes/js/underscore.min.js?ver=1.8.3" id="underscore-js"></script>
<script type="text/javascript" id="wp-util-js-extra">
/* <![CDATA[ */
var _wpUtilSettings = {"ajax":{"url":"\/bkolp\/wp-admin\/admin-ajax.php"}};
/* ]]> */
</script>
<script type="text/javascript" src="./wp-includes/js/wp-util.min.js?ver=5.7" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"daf7781282"};
/* ]]> */
</script>
...
<script type="text/javascript" src="./wp-admin/js/user-profile.min.js?ver=5.7" id="user-profile-js"></script>
	<div class="clear"></div>
	</body>
	</html>